...
const Dashboard = () => {
  ...
  const { data1, error, loading } = useGetProfileHook(
    `${BASE_URL}/doctor/${data._id}`
  );
              ...
              <div className="mt-8">
                {tab === "overview" && (
                  <div className="flex flex-col justify-center items-center gap-4 mb-10">
                    <figure className="">
                      <img src={data?.photo} alt="" className="custom-size object-contain" />
                    </figure>
                    <div className="flex flex-col items-center">
                      <span className="bg-[#CCF0F3] text-irisBlueColor py-1 px-4 lg:px-6 rounded text-[12px] leading-4 lg:text-[16px] lg:leading-6 font-semibold ">
                        {data.specialization ? data.specialization : "Genaral"}
                      </span>
